...
export interface ApiPredictionPrediction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    predictionConfidence: Attribute.Float &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          max: 1;
        ...
        number
      >;
    predictionStatus: Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    deliveryDate: Attribute.Date & Attribute.Required;
    ...
    hospitalName: Attribute.String & Attribute.Required;
    ...
    predictions: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::prediction.prediction'
    >;
